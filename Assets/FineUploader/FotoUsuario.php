...
if ($method == "POST") {
    ...
    if (isset($_GET["done"])) {
        $result = $uploader->combineChunks("../../SubidArchivos/archivos/fotosUsuario");
    }
    // Handles upload requests
    else {
        // Call handleUpload() with the name of the folder, relative to PHP's getcwd()
        $result = $uploader->handleUpload("../../SubidArchivos/archivos/fotosUsuario");
...
// for delete file requests
    ...
    $result = $uploader->handleDelete("../../SubidArchivos/archivos/fotosUsuario");
    echo json_encode($result);
}
else {
