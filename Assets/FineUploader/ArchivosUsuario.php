 ...
 *
 * 4. Ensure your "chunks" and "archivos" folders exist and are writable.
...
$uploader->allowedExtensions = array(); // all archivos types allowed by default
...
$uploader->chunksFolder = "../../SubidArchivos/temporal";
...
if ($method == "POST") {
    ...
    if (isset($_GET["done"])) {
        $result = $uploader->combineChunks("../../SubidArchivos/archivos/articulosUsuario");
    }
    // Handles upload requests
    else {
        // Call handleUpload() with the name of the folder, relative to PHP's getcwd()
        $result = $uploader->handleUpload("../../SubidArchivos/archivos/articulosUsuario");
...
// for delete file requests
    ...
    $result = $uploader->handleDelete("../../SubidArchivos/archivos/articulosUsuario");
    echo json_encode($result);
}
else {
