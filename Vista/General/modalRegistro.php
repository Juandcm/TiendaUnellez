...
<div class="modal animated flipInX small-modal in" id="registroTienda" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel">
...
<div class="clearfix">
		...
		<h5 class="text-light">Registrar en la tienda</h5>
		</div>
</div>
<div class="m-5"></div>
</div>
...
<input type="hidden" id="foto_usuario">
	...
	<div class="p-x-2 form-group m-b-0">
		<button type="button" id="botonRegistro" class="btn btn-success btn-block text-uppercase">Registrar</button>
	</div>
	</form>
</div>
</div>
