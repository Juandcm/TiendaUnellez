						...
						<div class="nav-fold">
							<a href="">
								...
								<span class="clear hidden-folded p-x">
									...
									<small class="block text-muted">Administrador</small>
								</span>
							</a>
						</div>
					</div>
					...
					<ul class="sidebar-menu">
						...
						<li class="<?= $active1 ?>">
							<a href="index.php" class="waves-effect  waves-light">
								...
								<span class="s-text">Articulos por aprobar</span>
							</a>
						</li>

						<li class="<?= $active2 ?>">
							<a href="index.php?vista=aprobados" class="waves-effect  waves-light">
	<!-- 		<span class="s-caret"><i class="fa fa-angle-down"></i></span>
		<span class="s-icon"><i class="ti-settings"></i></span> -->
		<span class="s-text">Articulos aprobados</span>
	</a>
</li>
...
<div class="site-content">
	...
	<div class="content-area p-y-1">
		...
		<div class="container-fluid">
			...
			switch ($vista) {
				case 'No':
				include 'Vista/Administrador/articuloAprobar.php';
				break;
				case 'aprobados':
				include 'Vista/Administrador/articuloAprobados.php';
				break;
				default:
				include 'Vista/Administrador/articuloAprobar.php';
				break;
